package cat.itacademy.barcelonactiva.martiComas.adria.s04.t02.n02.controllers;
...
public class FruitaController {
	...
	// Actualitzar fruita - http://localhost:8080/fruita/update/{id}
	@PutMapping("/update/{id}")
	public ResponseEntity<?> update(@RequestBody Fruita fruita, @PathVariable(value = "id") Long fruitaId) {
